...
angular.module('towns').value('PopulationConfig', {
  ...
  base_daily_cloths_need: 0.05,
  base_daily_food_consumption: 0.1,
  base_daily_food_regeneration: 0.1,
  base_daily_cloths_consumption: 0.01,
  base_daily_cloths_regeneration: 0.1
});
